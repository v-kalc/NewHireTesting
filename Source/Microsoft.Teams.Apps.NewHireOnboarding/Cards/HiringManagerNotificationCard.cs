...
namespace Microsoft.Teams.Apps.NewHireOnboarding.Cards
{
    ...
    public static class HiringManagerNotificationCard
    {
        ...
        /// </summary>
        private const int ImageHeight = 110;
            ...
            IntroductionEntity introductionEntity)
        {
            ...
            var questionAnswerList = JsonConvert.DeserializeObject<List<IntroductionQnA>>(introductionEntity.NewHireQuestionnaire);
                ...
                new AdaptiveSubmitAction
                {
                    ...
                    Data = new AdaptiveSubmitActionData
                    {
                        Msteams = new CardAction
                        {
                            ...
                            Text = Constants.ApproveIntroductionAction,
                        },
                        Command = Constants.ApproveIntroductionAction,
                        IntroductionEntity = introductionEntity,
                    },
                });
        ...
        public static Attachment GetTeamConfirmationCard(List<Models.TeamDetail> teamChannelMapping, IStringLocalizer<Strings> localizer, IntroductionEntity introductionEntity, bool isTeamSelected = true)
        {
            ...
            AdaptiveCard card = new AdaptiveCard(Constants.AdaptiveCardVersion)
            {
                Body = new List<AdaptiveElement>
                {
                    ...
                    new AdaptiveSubmitAction
                    {
                        ...
                        Data = new AdaptiveSubmitActionData
                        {
                            Msteams = new CardAction
                            {
                                ...
                                Text = Constants.PostTeamNotificationAction,
                            },
                            IntroductionEntity = introductionEntity,
                            Command = Constants.PostTeamNotificationAction,
                        },
                    },
                },
            };
            ...
            AdaptiveCard card = new AdaptiveCard(Constants.AdaptiveCardVersion)
            {
                Body = new List<AdaptiveElement>
                {
                    new AdaptiveTextBlock
                    {
                        Weight = AdaptiveTextWeight.Bolder,
                        Spacing = AdaptiveSpacing.Medium,
                        Text = localizer.GetString("MoreInfoCardHeaderText"),
                        Wrap = true,
                    },
                    new AdaptiveTextBlock
                    {
                    ...
                    new AdaptiveSubmitAction
                    {
                        ...
                        Data = new AdaptiveSubmitActionData
                        {
                            Msteams = new CardAction
                            {
                                ...
                                Text = Constants.RequestMoreInfoAction,
                            },
                            IntroductionEntity = introductionEntity,
                        },
                    },
