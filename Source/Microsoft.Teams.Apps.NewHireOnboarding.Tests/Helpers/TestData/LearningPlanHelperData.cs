...
namespace Microsoft.Teams.Apps.NewHireOnboarding.Tests.Helpers.TestData
{
    ...
    public static class LearningPlanHelperData
    {
        ...
        public static readonly IOptions<SharePointAuthSettings> sharePointAuthOptions = Options.Create(new SharePointAuthSettings()
        {
            TenantId = "{Application tenant id}",
            ClientId = "{Application id}",
            ClientSecret = "{Application password or secret}",
        });
